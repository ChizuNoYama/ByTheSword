...
{
    public const float MOVEMENT_STEP = 32f; // Grid Size
    public const double PLAYER_TURN_TIMER_INTERVAL = 150; // in milliseconds
    ...
    public const string ACTION_SKIP_TURN = "skip_turn";
